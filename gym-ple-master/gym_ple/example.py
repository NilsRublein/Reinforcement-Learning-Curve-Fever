...
"""
This file runs a pygame implementation of flappy bird in a gym env using gym-ple and saves
relevant stats in a json fiel as well as a video of the training.
